...
!:
	...
	sta dest: speedstart,x // store the speedcode here (self modifying)
	inx
	cpx #templatex_len
	bne !-

	lda dest						// self modify the destination
	clc
	adc #templatex_len
	sta dest
	lda dest+1
	...
	// End of speed code
	lda dest			// Copy the correct pointer into the self modifying code
	sta destend
	lda dest+1
	sta destend+1
